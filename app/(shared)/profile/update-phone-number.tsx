...
const UpdatePhoneNumber = () => {
  ...
  const canSendOtp = phone.length > 0 && !otpSent && !sendingOtp;
  ...
  return (
    <SafeAreaView className="flex-1" edges={["top", "left", "right"]}>
      ...
      <LinearGradient colors={["#D3E6FF", "#FFFFFF"]} locations={[0, 0.4]} style={{ flex: 1 }}>
        ...
        >
          <View>
            <Text className="mt-5 text-sm">Your email is used for account recovery.</Text>

            <Text className="mt-3.5 text-sm font-sf-pro-medium">Phone Number</Text>
            <View className="flex-row items-center gap-3">
              <TextInput
                className="flex-1 mt-2 py-4 px-4 border border-[#E3E6F0] rounded-xl bg-white"
