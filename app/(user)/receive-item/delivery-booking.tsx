...
const SelectVehicle = () => {
  ...
  const handleSelectRideNext = () => {
    if (selectedVehicle) {
      setCurrentStep("sender-details");
    }
  };

  // step 2
  // Called when user clicks "Confirm Sender" button
  const handleSenderDetailsNext = () => {
    Keyboard.dismiss();
  ...
  const handleCancelRide = () => {
    ...
    setSenderDetails({ name: "", phone: "", address: "" });
  };
      ...
      <View style={{ flex: 1 }}>
        ...
        >
          ...
          >
            ...
            {currentStep === "sender-details" && (
              <SenderDetails
                senderDetails={senderDetails}
                onDetailsChange={setSenderDetails}
                onNext={handleSenderDetailsNext}
                onSkip={handleSenderDetailsSkip}
                onBack={handleSenderDetailsBack}
              />
            )}
