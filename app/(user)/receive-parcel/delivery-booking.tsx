      ...
      <View style={{ flex: 1 }}>
        ...
        >
          ...
          >
            ...
            {currentStep === "parcel-details" && (
              <ParcelDetails
                parcelDetails={parcelDetails}
                onDetailsChange={setParcelDetails}
                onNext={handleParcelDetailsNext}
                onSkip={handleParcelDetailsSkip}
                onBack={handleParcelDetailsBack}
              />
            )}
